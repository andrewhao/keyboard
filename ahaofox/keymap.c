/*
Copyright 2018 Andrew Hao <andrewhao@gmail.com>
...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [0] = KEYMAP( \
        KC_GESC, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,    KC_MINS, KC_EQL, KC_GRV, KC_BSLS,MO(3), \
        ...
        MO(1),   KC_LALT,KC_LGUI,                        KC_SPC,                 KC_RGUI,MO(2),   KC_NO,           KC_LEFT,KC_DOWN,KC_RGHT \
    ),
    /* Layer 1: FN Layer
     * ,---------------------------------------------------------------.
    ...
    [1] = KEYMAP( \
        ...
        KC_TRNS,KC_TRNS,BL_DEC,                         BL_TOGG,                BL_INC,KC_TRNS,KC_TRNS,        KC_HOME,KC_PGDN,KC_END  \
    ),
    /* Layer 2: Magic Layer
     * ,---------------------------------------------------------------.
     * |   |   |   |   |   |   |   |   |   |   |   |   |   |       |   |
    ...
    [3] = KEYMAP( \
        ...
        KC_TRNS,KC_TRNS,KC_MS_L,KC_MS_D,KC_MS_R,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,        KC_TRNS,\
        KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,        KC_TRNS,KC_TRNS,\
        KC_TRNS,KC_TRNS,KC_TRNS,                        KC_TRNS,                KC_TRNS,KC_TRNS,KC_TRNS,        KC_TRNS,KC_TRNS,KC_TRNS \
    ),
};
